...
use ArtisanCloud\Rankable\Http\Controllers\API\RankAPIController;
...
Route::group(
    ...
    Route::match($_methodPut, 'rank/item', [RankAPIController::class, 'apiRankItem'])->name('rank.write.place.item');
